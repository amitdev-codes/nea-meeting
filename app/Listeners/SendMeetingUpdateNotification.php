        ...
        try {
            ...
            foreach ($users as $user) {
                try {
                    ...
                    \Log::error('Failed to send meeting update notification for user #' . $user->id . ': ' . $e->getMessage());
                }
            }
        ...
        try {
            ...
            foreach ($externalContacts as $contact) {
                try {
                    ...
                    \Log::error('Failed to send meeting update notification to external contact #' . $contact->id . ': ' . $e->getMessage());
                }
            }

...
} from "./chunk-3F4ABMOH.js";
import {
  bootstrap_esm_exports
} from "./chunk-IGULCJQW.js";
import {
  require_jquery
...
// node_modules/laravel-datatables-vite/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs
...
var dataTables_bootstrap5_default2 = jquery_dataTables_default;
...
$5.extend(true, dataTables_bootstrap5_default2.Buttons.defaults, {
  dom: {
    container: {
...
dataTables_bootstrap5_default2.ext.buttons.collection.className += " dropdown-toggle";
dataTables_bootstrap5_default2.ext.buttons.collection.rightAlignClassName = "dropdown-menu-right";
...
$6.extend(true, jquery_dataTables_default.defaults, {
  dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
  renderer: "bootstrap"
});
$6.extend(jquery_dataTables_default.ext.classes, {
  sWrapper: "dataTables_wrapper dt-bootstrap5",
  sFilterInput: "form-control form-control-sm",
  sLengthSelect: "form-select form-select-sm",
  sProcessing: "dataTables_processing card",
...
function info(api) {
  ...
  $7.each(ctx.aanFeatures.i, function(i, el) {
    el = $7(el);
...
$7.extend(jquery_dataTables_default.ext.buttons, {
  selected: {
...
$7.fn.DataTable.select = jquery_dataTables_default.select;

...
return [
    ...
    'theme' => 'theme-default.scss', // Options[String]: theme-default(default), theme-bordered, theme-semi-dark
    'style' => 'light', // Options[String]: light(default), 'dark' & 'system' mode
    'rtlSupport' => false, // options[Boolean]: true(default), false // To provide RTLSupport or not
    // 'rtlMode' => false, // options[Boolean]: false(default), true // To set layout to RTL layout  (myRTLSupport must be true for rtl mode)

...
class FaqDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->buttons(
                array_merge(
                    $this->dtActionModalButtons('faqs', 'Faq'),
                )
            )
            ->parameters([
                'initComplete' => 'function() {
                    ' . $this->initBulkDeleteScript('faq_ids[]') . '

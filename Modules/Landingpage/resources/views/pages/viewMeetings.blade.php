    ...
    <main class="main-content py-5" style="min-height: calc(100vh - 140px);">
        <div class="container-fluid px-4">
            ...
            <div class="card main-card shadow-sm border-0" style="border-radius: 15px; overflow: hidden;">
                <!-- Gradient Header -->
                <div class="card-header bg-gradient-primary py-4 d-flex align-items-center">
                            ...
                            <div class="row gy-4 nepali_td">
                                ...
                                <div class="col-12">
                                    <div class="date-time-container p-3">
                                        <div class="row g-3">
                                            <x-resource.detail-item label="{{ __('field.meeting_date') }}" :value="$resource->meeting_date .
                                                ' (' .
                                                $resource->meeting_date_ad .
                                                ')' ??
                                                'N/A'"
                                                class="col-md-6">

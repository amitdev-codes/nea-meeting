<div>
    ...
    <div class="input-group input-group-merge @error($attributes['name']) is-invalid @enderror">
        <input type="number" step="0.01" class="form-control @error($attributes['name']) is-invalid @enderror"
            ...
            @if ($attributes['required']) required @endif aria-label="Amount (to two decimal places)">
    </div>

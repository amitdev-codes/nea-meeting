$(function() {
    var e=$(".select2"), l=$(".selectpicker"); l.length&&l.selectpicker(), e.length&&e.each(function() {
        var e=$(this); e.wrap('<div class="position-relative"></div>'), e.select2( {
            placeholder:"Select value", dropdownParent:e.parent()
          }
...
function() {
  ...
  //used in ours form and modified it made it linear added validation
